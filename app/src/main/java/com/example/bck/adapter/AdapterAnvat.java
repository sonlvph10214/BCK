...
public class AdapterAnvat extends RecyclerView.Adapter<AdapterAnvat.ViewHolder>{

    List<AnVat> traSuaList;
    Context context;
    IFoodClickListener iFoodClickListener;

    public AdapterAnvat(List<AnVat> traSuaList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        AnVat traSua = traSuaList.get(position);
        if (traSua == null) {
            return;
        }
