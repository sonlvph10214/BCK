...
public class AdapterTraSua extends RecyclerView.Adapter<AdapterTraSua.ViewHolder>{

    List<TraSua> traSuaList;
    Context context;
    IFoodClickListener iFoodClickListener;

    public AdapterTraSua(List<TraSua> traSuaList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        TraSua traSua = traSuaList.get(position);
        if (traSua == null) {
            return;
        }
