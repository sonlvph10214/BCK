...
public class AdapterHot extends RecyclerView.Adapter<AdapterHot.ViewHolder>{

    List<Hot> traSuaList;
    Context context;
    IFoodClickListener iFoodClickListener;

    public AdapterHot(List<Hot> traSuaList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        Hot traSua = traSuaList.get(position);
        if (traSua == null) {
            return;
        }
