...
public class AdapterBun extends RecyclerView.Adapter<AdapterBun.ViewHolder>{

    List<Bun> bunList;
    Context context;
    IFoodClickListener iFoodClickListener;

    public AdapterBun(List<Bun> bunList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        Bun traSua = bunList.get(position);
        if (traSua == null) {
            return;
        }
